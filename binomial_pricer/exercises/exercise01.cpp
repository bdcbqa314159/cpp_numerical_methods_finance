/*
Tweak the code in Main02.cpp so
the user can enter n and i from the keyboard.
*/

/*
For S0=100., U = 0.9, D = 0.2, R = 0.5;
And: n=3, i=2;
We have:
q=0.428571
S(n,i )=433.2
...
int main()
{
    ...
    std::cin >> n;
    std::cout << "Enter i (specific node) ";
    std::cin >> i;
    std::cout << "\n";

    if (n < i)
    {
        std::cout << "node i must be <= than number of steps n" << std::endl;
        std::cout << "Terminating program" << std::endl;
        return 1;
    }
